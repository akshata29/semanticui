...
const datasetDefinitions: DatasetDefinition[] = [{
    ...
    datasetKind: DatasetKind.RetailServices,
    type: 'Document',
    indexName: 'ed4b83c4-5616-4e65-ad44-b384e149d965',
    fieldNames: ['questions', 'answer', 'source', 'keywords', 'parentIds', 'isContextOnly', 'prompts', 'lastUpdatedTimestampUTC', 'alternateQuestions'],
    keyField: 'id',
    captionFields: ['answer'],
    titleField: 'questions',
    attributionField: 'source',
}, {
